...
export const data = [
    ...
    sessions: [
      {
        ...
        eventYear: '2010',
        room: {
          name: 'Yaounde PrépaVogt',
          capacity: 20,
        },
      },
      {
        id: '58',
        title: 'Adobe XD Les bases',
        eventYear: '2021',
        room: {
          name: 'Meetin Online',
          capacity: 50,
    ...
    sessions: [
      {
        id: '1011',
        title:
          "Décomposition des applications pour l'évolutivité et la déployabilité",
        eventYear: '2022',
        room: {
          name: '4306',
          capacity: 100,
      ...
      {
        id: '1133',
        title: 'Développer des applications de persistance polyglotte',
        eventYear: '2019',
        room: {
          name: '5502',
          capacity: 70,
  ...
  },
  {
    ...
    first: 'Manang',
    last: 'Boris',
    company: 'Cabinet Manang et Associé',
    ...
    sessions: [
      ...
      {
        id: '677',
        title: 'Relation Internationnale et Strategie de Communication',
        eventYear: '2020',
        room: {
          name: 'Hotel Hilton',
          capacity: 70,
  ...
  },
  {
    ...
    sessions: [
      {
        id: '12',
        title: 'Hacking Ethique et Prévention',
        eventYear: '2022',
        room: {
          name: 'Yaoundé Palais des Congres',
          capacity: 23,
        },
      },
      {
        id: '121',
        title: 'Audit informatique et Analyse des systèmes',
        eventYear: '2021',
        room: {
          name: 'Douala IT Center',
          capacity: 30,
        },
      },
      {
  ...
  },
  {
    ...
    first: 'Audrey',
    last: 'Djieto',
    bio: 'Aspiring Data Scientist | Machine Learning | AI',
  ...
  },
  {
    ...
    sessions: [
      {
        id: '4820',
        title: 'Innovation pour les  ingénieures',
        eventYear: '2023',
        room: {
          name: 'RE-311',
          capacity: 68,
      ...
      {
        id: '6012',
        title: "L'internationalisation des startups",
        eventYear: '2016',
        room: {
          name: 'S-160',
          capacity: 60,
  ...
  },
  {
    ...
    sessions: [
      {
        id: '7549',
        title: 'Premiers Pas avec React JS',
        eventYear: '2021',
        room: {
          name: 'Helios High Tech Academy',
          capacity: 80,
        },
      },
    ],
  ...
  },
  {
    ...
    sessions: [
      {
        id: '86',
        title: 'Education la base pour le développement',
        eventYear: '2020',
        room: {
      ...
      {
        id: '6089',
        title: "Les 10 Repas de l'Esprit",
        eventYear: '2020',
        room: {
          name: 'Seed Innov',
          capacity: 55,
    ...
    sessions: [
      {
        id: '86',
        title:
          'Les limitations de performances de la plate-forme Java ... et comment les éviter',
        eventYear: '2008',
        room: {
          name: 'Cornell Hall',
          capacity: 0,
      ...
      {
        id: '7440',
        title: 'Comment penser comme un architecte logiciel',
        eventYear: '2023',
        room: {
          name: 'Douala Tech Center',
          capacity: 80,
        },
      },
    ],
  },
  {
    ...
    sessions: [
      {
        id: '86',
        title: 'Art du Copywriting',
        eventYear: '2020',
        room: {
          name: 'Yaounde BeeHive',
          capacity: 0,
        },
      },
      {
        id: '7551',
        title: 'La route du digital Entrepreneur',
        eventYear: '2021',
        room: {
          name: 'CazyLabs',
          capacity: 130,
